...
export function ImagesSliderSection() {
    ...
    return (
        <ImagesSlider
            className="h-[35vh] rounded-xl overflow-hidden"
            images={images}
        >
            <motion.div
                initial={{
            ...
            >
                <motion.p className="font-bold text-xl md:text-5xl text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 py-4">
                    Temukan kekuatan dalam kata-kata. Bergabunglah dengan tim
                    kami dan sampaikan cerita-cerita yang memukau dunia!
                </motion.p>
                <Link
                    href={"/auth/sign-up"}
